    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                                     ...
                                     [Button.url("المطـور 🔗", "https://t.me/devzein"), Button.inline(
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنـصيب اڤــــتار  🐍", data="deploy")],
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/devzein")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url(" 𓏺᥉᥆ᥙᖇᥴᥱ ᥲ᥎ᥲƚᥲᖇ❓", "https://t.me/sourceav")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @sourceav", alert=True)
