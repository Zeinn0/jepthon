    ...
    try:
        if BOTLOG:
            Config.CATUBLOGO = await l313l.tgbot.send_file(
                ...
                caption="**‏᯽︙ بــوت اڤــــتار يـعـمـل بـنـجـاح ✓ \n᯽︙ أرسل `.الاوامر`لرؤية اوامر السورس \n  ᯽︙ لأستعمال بوت الأختراق عبر كود التيرمكس أرسل`.هاك`**",
                buttons=[(Button.url("سورس اڤــــتار", "https://t.me/sourceav"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        descript = "- عزيزي المستخدم هذه هي مجموعه الاشعارات يرجى عدم حذفها  - @sourceav"
        photobt = await l313l.upload_file(file="l313l/razan/resources/start/Jepthon.JPEG")
        _, groupid = await create_supergroup(
            "مجموعة أشعارات اڤــــتار ", l313l, Config.TG_BOT_USERNAME, descript, photobt
        )
