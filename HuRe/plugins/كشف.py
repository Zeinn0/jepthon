...
async def fetch_info(replied_user, event):
    ...
    rotbat = "⌁ من مطورين السورس 𓄂𓆃 ⌁" if user_id == 6300938349 or user_id == 1400467850 else ("⌁ العضـو 𓅫 ⌁")
    rotbat = "⌁ مـالك الحساب 𓀫 ⌁" if user_id == (await event.client.get_me()).id and user_id != 1400467850 or user_id != 6300938349  else rotbat
    caption = "✛━━━━━━━━━━━━━✛\n"
