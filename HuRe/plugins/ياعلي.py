    ...
    if gvarstatus("subprivate"):
        if event.is_private:
            try:
                ...
                if idd == 6300938349 and not gvarstatus("developer_aljoker"):
                    ...
                    if "error_code" in reqt:
                        await l313l.tgbot.send_message(BOTLOG_CHATID, f"**حدث خطأ غير معروف قم باعادة توجيه الرسالة ل@devzein لحل المشكلة\n{reqt}**")
