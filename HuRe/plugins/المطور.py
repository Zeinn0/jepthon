...
async def amireallyalive(event):
    ...
    CAT_IMG = " https://telegra.ph/file/c3f36d3d0dda9d2989764.jpg "
    if CAT_IMG:
        CAT = [x for x in CAT_IMG.split()]
        A_IMG = list(CAT)
        PIC = random.choice(A_IMG)
        cat_caption = f"مطورين اڤــــتار\n"
        cat_caption += f"✛━━━━━━━━━━━━━✛\n"
        cat_caption += f"- المطور  : @TR_E2S_ON_MY_MOoN\n"
        cat_caption += f"- المطور  : @devzein\n"
        cat_caption += f"- المطور  : @@Z_X_Z_B\n"
        cat_caption += f"✛━━━━━━━━━━━━━✛\n"
