...
async def fetch_info(replied_user, event):
    ...
    rotbat = "⌁ من مطورين السورس 𓄂𓆃 ⌁" if user_id == 6300938349 or user_id == 1400467850 or user_id == 5593884330 or user_id == 5593884330 else ("⌁ العضـو 𓅫 ⌁")
